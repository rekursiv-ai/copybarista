...
# Folder export deletes the destination before copying the staged tree, so it refuses
# the filesystem root, home directory, source checkout, source root, and existing home-
